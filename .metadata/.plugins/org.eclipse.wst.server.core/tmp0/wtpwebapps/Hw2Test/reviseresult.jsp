...
<body>
	...
	<h1>查詢結果</h1> 
	<form action="main.html" method="post" enctype="multipart/form-data">    <table rules="all">
	...
	<!-- <table rules="all">       -->
		<tbody>
			...
			<tr>
                <td>編號</td>
                <td><jsp:getProperty name="reg" property="id"/></td>
            </tr>
			<tr>
                <td>活動名稱</td>
                <td><jsp:getProperty name="reg" property="name"/></td>
            </tr>
            <tr>
                <td>網址</td>
                <td><textarea name="description" rows="5" cols="40" ><jsp:getProperty name="reg" property="url"/></textarea></td>
            </tr>
           
            <tr>
                <td>活動描述</td>
                <td><jsp:getProperty name="reg" property="description"/></td>
            </tr>
            <tr>
                <td>備註</td>
                <td><jsp:getProperty name="reg" property="note"/></textarea></td>
            </tr>
