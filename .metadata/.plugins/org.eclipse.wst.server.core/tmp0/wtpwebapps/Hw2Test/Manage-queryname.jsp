...
<% String query=request.getSession(true).getAttribute("queryname").toString(); %>
<sql:query sql="select * from GrouponProduct where productname like '%${queryname}%'" var="rs" dataSource="${ds}" />
