 ...
 <div>
  <form action=".\UserServlet" method="post">
   ...
   <table rules="all">
    <tr>
     <td>請輸入要更改的單號</td>
     <td><input type="text" class="inputClass" name="uprid"
      id="in1"> <span id="idsp1" style="color: black;"></span> <span
      id="idsp2" style="color: red;"></span><br /></td>
    </tr>
    <tr>
     <td>請輸入要更改的貨號:</td>
     <td><label for="proName"></label> <input type="text"
      class="inputClass" name="uppid" id="in2" value=""> <span
      id="idsp3" style="color: black;"></span> <span id="idsp4"
    ...
    <tr>
     <td>請輸入更改後的數量:</td>
     <td><input type="text" class="inputClass" name="upcnt"
      id="in3"> <span id="idsp5" style="color: black;"></span> <span
      id="idsp6" style="color: red;"></span><br /></td>
    </tr>
   </table>
    <div class="wrap">
        <a href="user.jsp"><button type="submit" name="update" class="button">確認送出</button></a>
