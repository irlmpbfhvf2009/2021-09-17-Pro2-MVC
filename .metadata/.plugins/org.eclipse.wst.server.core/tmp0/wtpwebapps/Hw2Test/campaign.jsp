...
<body>
	<h2>活動資訊</h2>
		...
		<div>
			...
			<div  class="ss">
				<span>網址</span><input type="text" name="url" size="120" maxlength="120">
			</div>
			<div>
				<span>活動名稱</span><input type="text" name="name" size="10" maxlength="10" required>
			</div>
			<div>
			<span style="vertical-align:top">活動描述</span><textarea name="description" rows="6" cols="40"></textarea>
			</div>
			<div class="ss" >
