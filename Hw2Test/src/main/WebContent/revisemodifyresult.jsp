...
<body>
	...
	<tbody>
		...
		<tr>
			<td>編號</td>
			<td><textarea name="id" rows="1" cols="1" ><jsp:getProperty name="reg" property="id" /></textarea></td>
		</tr>
		<tr>
			<td>活動名稱</td>
			<td><textarea name="name" rows="3" cols="40"><jsp:getProperty name="reg" property="name" /></textarea></td>
		</tr>
		<tr>
			<td>網址</td>
			<td><textarea name="url" rows="3" cols="40"><jsp:getProperty name="reg" property="url"/></textarea></td>
		</tr>
	   
		<tr>
			<td>活動描述</td>
			<td><textarea name="description" rows="3" cols="40"><jsp:getProperty name="reg" property="description"/></textarea></td>
		</tr>
		<tr>
			<td>備註</td>
			<td><textarea name="note" rows="3" cols="40"><jsp:getProperty name="reg" property="note"/></textarea></td>
		</tr>
	   
	</tbody>
</table>
<div class="wrap" style="display: flex;margin-left: 150px;">
		<button type="submit" name="modify" class="button">送出</button>
