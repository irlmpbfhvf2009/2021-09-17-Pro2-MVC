...
<sql:query sql="select * from GrouponProduct where productName like '%${seach}%' " var="rs" dataSource="${ds}" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
    <nav>
        ...
        <input type="submit" name="seachbtn" value="搜尋">
        </form>
    </nav>
    <div class="divlist">
    <a href="Manage-add.jsp"><input class="sgbtn" type="button" value="發起團購"></a><br><br>
    <c:forEach var="row" items="${rs.rows}">
    <a href="Intelligence-product.jsp?id=${row.id}">
    ...
    <a href="Intelligence-product.jsp?id=${row.id}"><span class="productname">${row.productName}</span></a><br>
