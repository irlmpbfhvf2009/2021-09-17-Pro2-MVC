...
<jsp:useBean id="reg_memberUiBean" class="mvc.bean.MemberUiBean" scope="session" />
<!-- 
<div style="background-color: rgb(114, 13, 69);">
 ...
 <tr>
 	<td>帳號</td>
 	<td> 
    <jsp:getProperty name="reg_student" property="emailLogin" />
  ...
  <tr>
   ...
   <jsp:getProperty name="reg_memberUiBean" property="uiPhone" />  &nbsp;&nbsp;/&nbsp;&nbsp;
   ...
   <td>手機號碼</td>
   <td>
    <jsp:getProperty name="reg_memberUiBean" property="uiGender" />&nbsp;&nbsp;/&nbsp;&nbsp;  
   ...
   <tr>
    <td>性別</td>
     <td>
       <jsp:getProperty name="reg_memberUiBean" property="uiEmail" />&nbsp;&nbsp;/&nbsp;&nbsp; 
